                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <label className="flex items-center gap-2">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => setData('expose_to_frontend', !!checked)}
                                    />
                                    Expose to Frontend
                                </label>
                                <InputError message={errors.expose_to_frontend} />
                            </div>
                        </DialogHeader>
                        <DialogFooter>
                ...
                <TableBody>
                    {integrationSettings.map((setting) => (
                        <TableRow key={setting.id}>
                                ...
                                {setting.encrypted ? (
                                    ...
                                    <span className="flex items-center gap-2">
                                        ...
                                        <Button
                                            ...
                                            variant="ghost"
                                            type="button"
                                            onClick={() => setRevealedId(revealedId === setting.id ? null : setting.id)}
                                        >
                            ...
                            <TableCell>
                                <Checkbox checked={setting.encrypted} disabled />
                            </TableCell>
                            <TableCell>
