...
import { AlertTriangle, ArrowDown, ArrowUp, Trash } from 'lucide-react';
            ...
            <Form {...form}>
                ...
                >
                    ...
                    {shipmentUsage?.is_startup_plan &&
                        typeof shipmentUsage.remaining_shipments === 'number' &&
                        shipmentUsage.remaining_shipments <= 2 && (
                            <Card
                                className={cn(
                                    'border-2',
